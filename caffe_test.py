'''
Author:       kangyi
Introduction: This script uses a trained model to detect the object in a picture or a video
              To make it work, you need to 'cd ~/caffe' first, then 'python scripts/caffe_test.py'
'''
import numpy as np
